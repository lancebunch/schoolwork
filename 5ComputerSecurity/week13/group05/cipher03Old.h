...
public:
   virtual std::string getPseudoAuth()  { return "Rebecca D. Johnson"; }
   virtual std::string getCipherName()  { return "Keyed Vigenere Cipher"; }
   virtual std::string getEncryptAuth() { return "Jonathan Roberts"; }
   virtual std::string getDecryptAuth() { return "Jonathan Carlson"; }
   ...
   virtual std::string getPseudocode()
   {
      ...
      str += "   }\n";
      str += "   The plaintext(P) and key(K) are added modulo 26. [Ei = (Pi + Ki) mod 26]\n";
      ...
      str += "   Decryption by: [Di = (Ei - Ki + 26) mod 26]\n";
