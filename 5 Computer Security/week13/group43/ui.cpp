...
#include "cipher01.h"  // Include the other 5 header files
#include "cipher02.h"
#include "cipher03.h"
#include "cipher04.h"
#include "cipher05.h"
...
public:
   ...
   UI()
   {
      ...
      cipher.push_back(new Cipher01); // Vignere Cipher
      cipher.push_back(new Cipher02);
      cipher.push_back(new Cipher03);  // Rivest Cipher 4(RC4)
